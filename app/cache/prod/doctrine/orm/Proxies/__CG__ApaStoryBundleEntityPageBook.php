 ...
 */
class PageBook extends \Apa\StoryBundle\Entity\PageBook implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Apa\\StoryBundle\\Entity\\PageBook' . "\0" . 'chapter', '' . "\0" . 'Apa\\StoryBundle\\Entity\\PageBook' . "\0" . 'id', '' . "\0" . 'Apa\\StoryBundle\\Entity\\PageBook' . "\0" . 'number', '' . "\0" . 'Apa\\StoryBundle\\Entity\\PageBook' . "\0" . 'contents');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageBook $proxy) {
