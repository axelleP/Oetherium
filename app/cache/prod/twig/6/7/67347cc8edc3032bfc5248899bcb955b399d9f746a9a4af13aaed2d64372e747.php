            ...
            <ul class=\"nav navbar-nav\">
                <li class=\"dropdown user-menu\">
                    ...
                    <ul class=\"dropdown-menu dropdown-user\">
                        ";
        // line 38
        $this->loadTemplate($this->getAttribute((isset($context["admin_pool"]) ? $context["admin_pool"] : null), "getTemplate", array(0 => "user_block"), "method"), "SonataAdminBundle::layout.html.twig", 38)->display($context);
        // line 39
        echo "                    </ul>
                </li>
            </ul>
