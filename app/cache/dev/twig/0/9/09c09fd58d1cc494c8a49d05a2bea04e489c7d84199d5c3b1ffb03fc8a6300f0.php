...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        ";
        // line 24
        if (($this->getAttribute((isset($context["chapter"]) ? $context["chapter"] : $this->getContext($context, "chapter")), "id", array()) != (isset($context["idFirstChapter"]) ? $context["idFirstChapter"] : $this->getContext($context, "idFirstChapter")))) {
            // line 25
            echo "            <a class=\"boxLink\" itemprop=\"url\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("apa_story_chapter", array("numero" => ($this->getAttribute((isset($context["chapter"]) ? $context["chapter"] : $this->getContext($context, "chapter")), "number", array()) - 1))), "html", null, true);
        ...
        ";
        // line 28
        if (($this->getAttribute((isset($context["chapter"]) ? $context["chapter"] : $this->getContext($context, "chapter")), "id", array()) != (isset($context["idlLastChapter"]) ? $context["idlLastChapter"] : $this->getContext($context, "idlLastChapter")))) {
            // line 29
            echo "            <a class=\"boxLink\" itemprop=\"url\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("apa_story_chapter", array("numero" => ($this->getAttribute((isset($context["chapter"]) ? $context["chapter"] : $this->getContext($context, "chapter")), "number", array()) + 1))), "html", null, true);
...
";
    ...
    public function block_socialNetwork($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, strtr($this->getAttribute((isset($context["chapter"]) ? $context["chapter"] : $this->getContext($context, "chapter")), "title", array()), array(" " => "%20")), "html", null, true);
        echo "»%20-%20Oetherium\">
