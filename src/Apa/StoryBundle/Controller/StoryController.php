...
class StoryController extends Controller {
    ...
    public function seeCharactersAction() {
        ...
        return $this->render('ApaStoryBundle:Character:seeCharacters.html.twig', array('mainCharacters' => $mainCharacters, 'minorCharacters' => $minorCharacters));
    }
    ...
    public function seeCharacterProfileAction($firstname, $name) {
        ...
        return $this->render('ApaStoryBundle:Character:seeCharacterProfile.html.twig', array('characterProfile' => $characterProfile, 'images' => $images));
    }
    ...
    public function seeChaptersAction($page) {
        ...
        $pagination = $paginator->paginate(
                $chapters,
                $this->get('request')->query->get('page', $page), /* page active */ 10/* limite par page */
        );
    ...
    public function readChapterAction($numero, $page) {
        ...
        $pagination = $paginator->paginate(
                $pages,
                $this->get('request')->query->get('page', $page), /* page active */ 1/* limite par page */
        );

        return $this->render('ApaStoryBundle:Story:readChapter.html.twig', array('chapter' => $chapter, 'pagination' => $pagination, 'firstId' => $firstId[0]['id'], 'lastId' => $lastId[0]['id']));
    }
    ...
    public function seeAnnexTextsAction($page) {
        ...
        $pagination = $paginator->paginate(
                $annexTexts,
                $this->get('request')->query->get('page', $page), /* page active */ 5/* limite par page */
        );
